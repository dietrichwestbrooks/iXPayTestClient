...
namespace Wayne.Payment.Tools.iXPayTestClient.Business.TerminalCommands
{
    public static class ConvertHelper
    {
        ...
        public static byte[] ToHexByteArray(string hex)
        {
        ...
        public static byte[] ToImageByteArray(string imagePath)
        {
        ...
        public static byte[] ToImageByteArray(Image image, ImageFormat format)
        {
